...
<div class="x-body">
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <tbody>
            <c:forEach items="${sessionScope.recive}" var="mail" varStatus="stat">
                <form method="post" action="${ctx}/CheckMailSverlet">
                    <tr>
                        ...
                        <td><a href="${ctx}/DeleteReciveServlet?time=${mail.time}">删除</a></td>
